...
String PROJECTNAME = "vergunningcheck_redis"
String CONTAINERDIR = "."
...
String CONTAINERNAME = "ois/vergunningcheck_redis:${env.BUILD_NUMBER}"
...
if (BRANCH == "${PRODUCTION_BRANCH}") {
    ...
    stage('Waiting for approval') {
        slackSend channel: '#ci-channel-app', color: 'warning', message: 'jvvs_redis is waiting for Production Release - please confirm'
